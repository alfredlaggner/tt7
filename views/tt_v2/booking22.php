						...
						<div class="booking-section travelo-box">
							...
							<? if ($i == 1) : ?>
								...
								<? if (isset($events)) : foreach ($events as $event) : ?>
									...
									<input type="hidden" name="name" id="name" class="text" readonly="readonly"
									       value=''/>
							...
							<div class="person-information">
									...
									<div class="form-group col-sm-6 col-md-5">
										...
										<? else : ?>
											...
											<input type="text" class="input-text full-width" name="email<?= $i ?>"
											       id="email<?= $i ?>" value="" placeholder="Email"/>
										<? endif ?>
									</div>
									<div class="form-group col-sm-6 col-md-5">
										<? if ($i == 1) : ?>
											...
											<input type="text" class="input-text full-width validate[required]"
											       name="cell<?= $i ?>" id="cell<?= $i ?>" value=""
											       placeholder="cell required"/>
										<? else : ?>
											y
											<label>phone</label>
											<input type="text" class="input-text full-width" name="cell<?= $i ?>"
											       id="cell<?= $i ?>" value="" placeholder="cell"/>
										<? endif ?>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-sm-6 col-md-5">
										...
										<input type="text" class="input-text full-width" name="address1<?= $i ?>"
										       id="address1<?= $i ?>" value="" placeholder="home address"/>
									</div>
									<div class="col-xs-6">
										<label>State</label>
										<div class="selector">
								...
								<div class="row">
									<div class="form-group col-sm-6 col-md-5">
										...
										<input type="text" class="input-text full-width validate[required]"
										       name="emergency_contact<?= $i ?>" id="emergency_contact<?= $i ?>"
										       value="" placeholder="emergency contact"/>
									</div>
									<div class="form-group col-sm-6 col-md-5">
										<label>emergency phone</label>
										<input type="text" class="input-text full-width" name="emergency_phone<?= $i ?>"
										       id="emergency_phone<?= $i ?>" value="" placeholder="emergency phone"/>
									</div>
								</div>
