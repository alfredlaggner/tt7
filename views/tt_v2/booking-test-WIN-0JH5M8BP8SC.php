							...
							<div class="panel style1">
								<? if (isset($locations)) : foreach ($locations as $location) : ?>
									<h4 class="panel-title">
										<a class="collapsed" href="#acc2" data-toggle="collapse"
									...
									<div class="panel-collapse collapse" id="acc2">
										<div class="panel-content">
											...
											<? if (isset($events)) :foreach ($events as $event) : ?>
												...
												?>
												<p><a title="Click to select date and time"
...
--> </a></p>
									...
									<div class="panel style1">
										...
										<div class="panel-collapse collapse" id="acc<?= $j; ?>">
											<div class="panel-content">
												...
												<? endif ?>
												<h4 class="panel-title"><a href="#acc<?= $j; ?><?= $i; ?>"
												                           data-toggle="collapse" data-parent="#months">
	...
	--> </a>
															<? if ($event['is_two_days']) : ?>
																<span style="color:#00F">Please call <span
																		style="color:#C00">(650) 557-4893 </span> to make a last minute reservation! </span>
															<? endif ?>
															<? endif ?>
															<? $i++ ?>
														</div>    <!--day -->
