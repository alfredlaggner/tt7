							...
							<?php if (isset($rate_prices)) : foreach ($rate_prices as $rate_price) : ?>
								<tr>
									...
									<td><a class="btn_no_text btn ui-state-default ui-corner-all tooltip"
									       ...
									       href="<?php echo site_url() . 'activity_rate/rate_price_view/' . $rate_price->rate_price_id . '/' . $activity_id ?>">
											...
											href="<?php echo site_url() . 'activity_rate/delete_rate_price/' . $rate_price->rate_price_id . '/' . $activity_id ?>">
