					...
					<div id="inputform">
						<table>
							...
							foreach ($records as $row) : ?>
								...
								<input type="hidden" name="activity_picture_id" id="activity_picture_id"
								       value='<?php echo $row->activity_picture_id; ?>'/>
								<input type="hidden" name="activity_id" id="activity_id"
								       value='<?php echo $row->activity_id; ?>'/>
								<input type="hidden" name="folder" id="folder" value='<?php echo $row->folder; ?>'/>
								<tr>
									<td><img
											src="<?= base_url() . CLASSES_IMAGE_DIR . strtoupper($row->folder) . '/' . $row->picture ?>"
