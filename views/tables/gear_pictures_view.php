					...
					<div id="inputform">
						<table>
							...
							foreach ($records as $row) : ?>
								...
								<input type="hidden" name="gear_picture_id" id="gear_picture_id"
								       value='<?php echo $row->gear_picture_id; ?>'/>
								...
								<tr>
									<td><img
											src="<?= base_url() . GEARS_IMAGE_DIR . strtoupper($row->folder) . '/' . $row->picture ?>"
