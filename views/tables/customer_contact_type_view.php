				...
				<div id="inputform">
					<table>
						...
						foreach ($records as $row) : ?>
							...
							<tr>
								<input type="hidden" name="customer_contact_type_id" id="customer_contact_type_id"
								       value='<?php echo $row->customer_contact_type_id; ?>'/>
							<tr>
								<td><input type="text" name="code" id="code" class="text"
								           value='<?php echo $row->code; ?>'/></td>
							</tr>
							<tr>
								<td><input type="text" name="name" id="name" class="text"
								           value='<?php echo $row->name; ?>'/><br/><textarea class="text_area"
								                                                             name="description"
