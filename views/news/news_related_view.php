			...
			<div class="hastable">
				...
				<div class="hastable">
					...
					<table id="sort-table">
						...
						<tbody>
						<tr>
							<input type="hidden" value="<?php echo $row->news_id; ?>"
							       name="news_related_id<?php echo $i ?>" id="news_related_id<?php echo $i ?>"/>
						...
						<tr>
							...
							<input type="submit" name="return" value="Assign & Return"
							       class="ui-state-default float-right ui-corner-all ui-button"/>
							<input type="submit" name="assign_news" value="Assign news"
							       class="ui-state-default float-right ui-corner-all ui-button"/>
						</tr>
					</table>
					</form>
