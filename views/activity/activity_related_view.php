			...
			<div class="hastable">
				...
				<div class="hastable">
					...
					<table id="sort-table">
						...
						<tbody>
						<tr>
							<input type="hidden" value="<?php echo $row->activity_id; ?>"
							       name="activity_related_id<?php echo $i ?>" id="activity_related_id<?php echo $i ?>"/>
						...
						<tr>
							...
							<input type="submit" name="return" value="Assign & Return"
							       class="ui-state-default float-right ui-corner-all ui-button"/>
							<input type="submit" name="assign_activities" value="Assign Activites"
							       class="ui-state-default float-right ui-corner-all ui-button"/>
						</tr>
					</table>
					</form>
