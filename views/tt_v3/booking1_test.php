...
"xajax_verify_promo_code(xajax.getFormValues('booking<?= $j ?><?= $i ?>'),<?= $j ?><?= $i ?>,<?=$event['event_event_id'] ?>,<?=$event['exp_discount_price'] ?>);return false;" size="10" id="dspl_promo_code<?= $j ?><?= $i ?>" name="update" value="CONTINUE" class="submit" /></div>	
