...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			<h1><a id="go-top"></a>Environmental Stewardship </h1>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-7">
			...
			<p><a name="go-top"></a>We are committed to allocating our resources to help preserve the planet.
				Treks
				and Tracks is a proud member of the 1% for the planet organization. This means 1% of our gross revenue
				goes
				to organizations that help preserve the environment we cherish.</p>
			<p>Please do your part in preserving the places we love by simpling following Leave No Trace
				principles. </p>
			<h5><br/>
				<span> Treks and Tracks outdoor ethics from the framework of Leave No Trace's message:</span></h5>
			<ol start="1" type="1">
				<ul>
					<li><a href="#planahead">Plan Ahead and Prepare </a></li>
				</ul>
				<ul>
					<li><a href="#travelandcamp">Travel and Camp on Durable
							Surfaces</a></li>
				</ul>
				<ul>
					<li><a href="#disposeofwaste">Dispose of Waste
							Properly</a>
					</li>
				</ul>
				<ul>
					<li><a href="#leavewhatyoufind">Leave What You Find</a>
					</li>
				</ul>
				<ul>
					<li><a href="#minimizecampfire">Minimize Campfire
							Impact</a>
					</li>
				</ul>
				<ul>
					<li><a href="#respectwildlife">Respect Wildlife</a></li>
				</ul>
				<ul>
					<li><a href="#beconsiderate">Be Considerate of Other
							Visitors</a>
					</li>
				</ul>
				<p>&nbsp;</p>
				<p>&nbsp;</p>
				<h4><a id="planahead"></a>Plan Ahead and Prepare</h4>
				<ul type="disc">
					...
					<p><a href="#go-top">Go top</a></p>
				</ul>
				<h4><a name="travelandcamp" id="travelandcamp"></a>Travel and Camp on Durable Surfaces</h4>
				<ul type="disc">
					<li>Durable surfaces include established trails and campsites, rock, gravel, dry grasses or snow.
					</li>
				...
				<ul type="disc">
					<li>Pack it in, pack it out. Inspect your campsite and rest areas for trash or spilled foods. Pack
						out
						all trash, leftover food, and litter.
					</li>
					<li>Deposit solid human waste in catholes dug 6 to 8 inches deep at least 200 feet from water, camp,
						and
						trails. Cover and disguise the cathole when finished.
					</li>
					<li>Pack out toilet paper and hygiene products.</li>
					<li>To wash yourself or your dishes, carry water 200 feet away from streams or lakes and use small
				...
				<ul type="disc">
					<li>Preserve the past: examine, but do not touch, cultural or historic structures and artifacts.
					</li>
				...
				<ul type="disc">
					<li>Campfires can cause lasting impacts to the backcountry. Use a lightweight stove for cooking and
				...
				<ul type="disc">
					...
					<li>Never feed animals. Feeding wildlife damages their health, alters natural behaviors, and exposes
					...
					<p><a class="go-top" href="<?= site_url() ?>menu_pages_v3/environment#go-top">Go top</a></p>
				</ul>
				...
				<h4><strong>&nbsp;</strong></h4>
				<p>
					<!--<a href="<?= site_url() ?>menu_pages_v3/environment#go-top"><img src="<?= base_url() . PAGES_IMAGE_DIR ?>logo_vert_standard_color.jpg" alt="one percent for the planet" width="182" height="267" align="left" /></a>--><img
