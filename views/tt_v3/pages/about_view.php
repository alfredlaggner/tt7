...
<div class="container">
	...
	<div class="row">
		<div class="col-md-7">
			<article id="blog-post"><p><img
						src="<?= base_url() . PAGES_IMAGE_DIR ?>25984_382756256819_668686819_4350625_4333678_n.jpg"
						alt="" class="img-fluid"/> Treks and Tracks offers various courses and
					experiences in outdoor activities. Be it rock climbing, backpacking or a navigation course, we
					strive to
					offer the highest quality experience to our clientele.</p>
				<p>We hold our guides to the highest safety and guiding standards in the industry. All guides are
					trained in
					wilderness emergency procedures and professional guiding techniques. With over 30 years of combined
					outdoor adventure experience, each expedition and class has been carefully crafted to ensure an
				...
				<p>Operating since 2010, the mission of Treks and Tracks is to provide professional, fun and rewarding
					...
					inherent
					in these activities. In addition, we strive to instill a sense of awe for and stewardship towards
					the
					natural world.</p>
				...
				<p>We currently operate in six State and National Parks throughout the state of California. Our
					activities
					include rock climbing instruction of all levels, rappelling, overnight backpacking, map and compass
					navigation and tailored corporate team building events.</p>
				<p>&nbsp;</p>
				...
				<div class="line">
					<p>&nbsp;</p>
					<p>&nbsp;</p>
					<p><img src="<?= base_url() . PAGES_IMAGE_DIR ?>amga_spi.jpg" alt="AMGA certified guides"
					        width="200"
					        height="256"
					        align="left"/></p>
			</article>
