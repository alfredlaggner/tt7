...
<div id="sub-nav">
	<div class="page-title">
		...
		<span><a href="#" title="Home">Home</a> > <a href="#"
		                                             title="Dashboard">Dashboard</a> > <?= anchor('gear', 'gear Overview'); ?>
...
-->
							...
							<li>
								<label>Group</label>
								<select type="text" name="gear_group_id" id="gear_group_id" class="text"
								        value='<?= $row->gear_group_id; ?>'/>

								<? if (isset($gear_groups)) : foreach ($gear_groups as $gear_group) : ?>
									<? if ($row->gear_group_id == $gear_group->gear_group_id) : ?>
										<option selected
										        value="<?= $gear_group->gear_group_id; ?>"><?= $gear_group->name; ?></option>
									<? else : ?>
										<option
											value="<?= $gear_group->gear_group_id; ?>"><?= $gear_group->name; ?></option>
									<? endif; ?>
