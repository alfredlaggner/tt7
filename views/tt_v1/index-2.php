						...
						<div class="col-sms-6 col-sm-6 col-md-3">
							<article class="box">
								<figure class="animated" data-animation-type="fadeInDown" data-animation-duration="1">
									<a href="<?= site_url() . 'tt_v1/product/' . $row->activity_id . '/photos_tab' ?>"
								...
								<div class="details">
									...
									<h4 class="box-title"><a
											href="<?= site_url() . 'tt_v1/product/' . $row->activity_id ?>">Atlantis -
											The Palm
											<small>Paris</small>
										</a></h4>
								</div>
					...
					<div class="col-sms-6 col-sm-6 col-md-3">
						<article class="box">
							<figure class="animated" data-animation-type="fadeInDown" data-animation-duration="1"
								...
								<a href="ajax/slideshow-popup.html" title="" class="hover-effect "><img
										src="http://placehold.it/270x160" alt="" width="270" height="160"/></a>
							</figure>
							<div class="details">
								<span class="price"><small>FROM</small>$170</span>
								<h4 class="box-title"><a href="hotel-detailed.html">Hilton Hotel
										<small>LONDON</small>
									</a></h4>
							</div>
						</article>
					...
					<div class="col-sms-6 col-sm-6 col-md-3">
						<article class="box">
							...
							<div class="details">
								...
								<h4 class="box-title"><a href="hotel-detailed.html">MGM Grand
					...
					<div class="col-sms-6 col-sm-6 col-md-3">
						<article class="box">
							...
							<div class="details">
								...
								<h4 class="box-title"><a href="hotel-detailed.html">Crown Casino
		...
		<div class="honeymoon section global-map-area promo-box parallax" data-stellar-background-ratio="0.5">
			<div class="container">
				<div class="col-sm-6 content-section description pull-right">
					...
					<p>Nunc cursus libero purusac congue arcu cursus utsed vitae pulvinar massa idporta neque purusac
								...
								<figure>
									<a href="hotel-list-view.html" title=""
									   ...
									   data-animation-duration="1" data-animation-delay="0.4"><img
											src="http://placehold.it/370x170" alt=""/></a>
								</figure>
								<div class="details">
				...
				<div class="col-sm-6 image-container no-margin">
					<img src="http://placehold.it/524x540" alt="" class="animated" data-animation-type="fadeInUp"
