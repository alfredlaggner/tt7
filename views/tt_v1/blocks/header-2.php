<header id="header" class="navbar-static-top">
	...
	<div class="main-header"><a href="#mobile-menu-01" data-toggle="collapse" class="mobile-menu-toggle"> Mobile Menu
			Toggle </a>
		<div class="container">
			<h1 class="logo navbar-brand"><a href="<?= base_url() ?>" title="Travelo - home"> <img
						src="<?= site_url() ?>travelo/images/logo.png" alt="Travelo HTML5 Template"/> </a></h1>
				...
				<ul class="menu">
					...
					<li class="menu-item-has-children"><a href="tour-index.html">Tour</a>
						<ul>
							...
							<li><a href="<?= site_url() ?>travelo/tour-fancy-package-2column.html">Fancy Packages 2
									Column</a></li>
							<li><a href="<?= site_url() ?>travelo/tour-fancy-package-3column.html">Fancy Packages 3
									Column</a></li>
							<li><a href="<?= site_url() ?>travelo/tour-fancy-package-4column.html">Fancy Packages 4
									Column</a></li>
							<li><a href="<?= site_url() ?>travelo/tour-simple-package-2column.html">Simple Packages 2
									Column</a></li>
							<li><a href="<?= site_url() ?>travelo/tour-simple-package-3column.html">Simple Packages 3
									Column</a></li>
							<li><a href="<?= site_url() ?>travelo/tour-simple-package-4column.html">Simple Packages 4
									Column</a></li>
							<li><a href="<?= site_url() ?>travelo/tour-simple-package-3column.html">Location -
									Eruope</a></li>
							<li><a href="<?= site_url() ?>travelo/tour-simple-package-4column.html">Location - North
									America</a></li>
							...
							<div class="megamenu-holder">
								<ul class="megamenu">
									<li class="menu-item-has-children"><a href="#">Standard Pages</a>
										<ul class="clearfix">
											<li><a href="<?= site_url() ?>travelo/pages-aboutus1.html">About Us 1</a>
											</li>
											<li><a href="<?= site_url() ?>travelo/pages-aboutus2.html">About Us 2</a>
											</li>
											<li><a href="<?= site_url() ?>travelo/pages-services1.html">Services 1</a>
											</li>
											<li><a href="<?= site_url() ?>travelo/pages-services2.html">Services 2</a>
											</li>
											<li><a href="<?= site_url() ?>travelo/pages-photogallery-4column.html">Gallery
													4 Column</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-photogallery-3column.html">Gallery
													3 Column</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-photogallery-2column.html">Gallery
													2 Column</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-photogallery-fullview.html">Gallery
													Read</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-blog-rightsidebar.html">Blog
													Right Sidebar</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-blog-leftsidebar.html">Blog Left
													Sidebar</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-blog-fullwidth.html">Blog Full
													Width</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-blog-read.html">Blog Read</a>
											</li>
											<li><a href="<?= site_url() ?>travelo/pages-faq1.html">Faq 1</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-faq2.html">Faq 2</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-layouts-leftsidebar.html">Layouts
													Left Sidebar</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-layouts-rightsidebar.html">Layouts
													Right Sidebar</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-layouts-twosidebar.html">Layouts
													Two Sidebar</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-layouts-fullwidth.html">Layouts
													Full Width</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-contactus1.html">Contact Us
													1</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-contactus2.html">Contact Us
													2</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-contactus3.html">Contact Us
													3</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-travelo-policies.html">Travelo
													Policies</a></li>
									...
									<li class="menu-item-has-children"><a href="#">Extra Pages</a>
										<ul class="clearfix">
											<li>
												<a href="<?= site_url() ?>travelo/extra-pages-holidays.html">Holidays</a>
											</li>
											<li><a href="<?= site_url() ?>travelo/extra-pages-hotdeals.html">Hot
													Deals</a></li>
											<li><a href="<?= site_url() ?>travelo/extra-pages-before-you-fly.html">Before
													You Fly</a></li>
											<li><a href="<?= site_url() ?>travelo/extra-pages-inflight-experience.html">Inflight
													Experience</a></li>
											<li><a href="<?= site_url() ?>travelo/extra-pages-things-todo1.html">Things
													To Do 1</a></li>
											<li><a href="<?= site_url() ?>travelo/extra-pages-things-todo2.html">Things
													To Do 2</a></li>
											<li><a href="<?= site_url() ?>travelo/extra-pages-travel-essentials.html">Travel
													Essentials</a></li>
											<li><a href="<?= site_url() ?>travelo/extra-pages-travel-stories.html">Travel
													Stories</a></li>
											<li><a href="<?= site_url() ?>travelo/extra-pages-travel-guide.html">Travel
													Guide</a></li>
											<li><a href="<?= site_url() ?>travelo/extra-pages-travel-ideas.html">Travel
													Ideas</a></li>
											<li><a href="<?= site_url() ?>travelo/extra-pages-travel-insurance.html">Travel
													Insurance</a></li>
											<li><a href="e<?= site_url() ?>travelo/xtra-pages-group-booking.html">Group
													Bookings</a></li>
										</ul>
									</li>
									<li class="menu-item-has-children"><a href="#">Special Pages</a>
										<ul class="clearfix">
											...
											<li><a href="<?= site_url() ?>travelo/pages-coming-soon1.html">Coming Soon
													1</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-coming-soon2.html">Coming Soon
													2</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-coming-soon3.html">Coming Soon
													3</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-loading1.html">Loading Page
													1</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-loading2.html">Loading Page
													2</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-loading3.html">Loading Page
													3</a></li>
											<li><a href="<?= site_url() ?>travelo/pages-login1.html">Login Page 1</a>
											</li>
											<li><a href="<?= site_url() ?>travelo/pages-login2.html">Login Page 2</a>
											</li>
											<li><a href="<?= site_url() ?>travelo/pages-login3.html">Login Page 3</a>
											</li>
										</ul>
									</li>
								</ul>
					...
					<li class="menu-item-has-children"><a href="#">Shortcodes</a>
						<ul>
							<li><a href="<?= site_url() ?>travelo/shortcode-accordions-toggles.html">Accordions &amp;
									Toggles</a></li>
							...
							<li><a href="<?= site_url() ?>travelo/shortcode-gallery-styles.html">Image &amp; Gallery
									Styles</a></li>
							<li><a href="<?= site_url() ?>travelo/shortcode-image-box-styles.html">Image Box Styles</a>
							</li>
							<li class="menu-item-has-children"><a href="#">Listing Styles</a>
								<ul>
									<li><a href="<?= site_url() ?>travelo/shortcode-listing-style1.html">Listing Style
											01</a></li>
									<li><a href="<?= site_url() ?>travelo/shortcode-listing-style2.html">Listing Style
											02</a></li>
									<li><a href="<?= site_url() ?>travelo/shortcode-listing-style3.html">Listing Style
											03</a></li>
								</ul>
							</li>
					...
					<li class="menu-item-has-children"><a href="#">Bonus</a>
						<ul>
							...
							<li class="menu-item-has-children"><a href="#">7 Inner Start Styles</a>
								<ul>
									<li><a href="#">Default Style</a></li>
									<li><a href="<?= site_url() ?>travelo/inner-starts-style1.html">Inner Start Style
											1</a></li>
									<li><a href="<?= site_url() ?>travelo/inner-starts-style2.html">Inner Start Style
											2</a></li>
									<li><a href="<?= site_url() ?>travelo/inner-starts-style3.html">Inner Start Style
											3</a></li>
									<li><a href="<?= site_url() ?>travelo/inner-starts-style4.html">Inner Start Style
											4</a></li>
									<li><a href="<?= site_url() ?>travelo/inner-starts-style5.html">Inner Start Style
											5</a></li>
									<li><a href="<?= site_url() ?>travelo/inner-starts-style6.html">Inner Start Style
											6</a></li>
								</ul>
							</li>
			...
			<ul id="mobile-primary-menu" class="menu">
				...
				<li class="menu-item-has-children"><a href="<?= site_url() ?>travelo/tour-index.html">Tour</a>
					<ul>
						...
						<li><a href="<?= site_url() ?>travelo/tour-simple-package-4column.html">Simple Packages 4
								Column</a></li>
						<li><a href="<?= site_url() ?>travelo/tour-simple-package-3column.html">Location - Eruope</a>
						</li>
						<li><a href="<?= site_url() ?>travelo/tour-simple-package-4column.html">Location - North
								America</a></li>
						<li><a href="<?= site_url() ?>travelo/tour-detailed1.html">Detailed 1</a></li>
					...
					<ul>
						<li class="menu-item-has-children"><a href="#">Standard Pages</a>
							<ul>
								...
								<li><a href="<?= site_url() ?>travelo/pages-photogallery-4column.html">Gallery 4
										Column</a></li>
								<li><a href="<?= site_url() ?>travelo/pages-photogallery-3column.html">Gallery 3
										Column</a></li>
								<li><a href="<?= site_url() ?>travelo/pages-photogallery-2column.html">Gallery 2
										Column</a></li>
								<li><a href="<?= site_url() ?>travelo/pages-photogallery-fullview.html">Gallery Read</a>
								</li>
								<li><a href="<?= site_url() ?>travelo/pages-blog-rightsidebar.html">Blog Right
										Sidebar</a></li>
								<li><a href="<?= site_url() ?>travelo/pages-blog-leftsidebar.html">Blog Left Sidebar</a>
								</li>
								<li><a href="<?= site_url() ?>travelo/pages-blog-fullwidth.html">Blog Full Width</a>
								</li>
								<li><a href="<?= site_url() ?>travelo/pages-blog-read.html">Blog Read</a></li>
								<li><a href="<?= site_url() ?>travelo/pages-faq1.html">Faq 1</a></li>
								<li><a href="<?= site_url() ?>travelo/pages-faq2.html">Faq 2</a></li>
								<li><a href="<?= site_url() ?>travelo/pages-layouts-leftsidebar.html">Layouts Left
										Sidebar</a></li>
								<li><a href="<?= site_url() ?>travelo/pages-layouts-rightsidebar.html">Layouts Right
										Sidebar</a></li>
								<li><a href="<?= site_url() ?>travelo/pages-layouts-twosidebar.html">Layouts Two
										Sidebar</a></li>
								<li><a href="<?= site_url() ?>travelo/pages-layouts-fullwidth.html">Layouts Full
										Width</a></li>
								...
								<li><a href="<?= site_url() ?>travelo/pages-travelo-policies.html">Travelo Policies</a>
								</li>
								<li><a href="<?= site_url() ?>travelo/pages-sitemap.html">Site Map</a></li>
							</ul>
						</li>
						<li class="menu-item-has-children"><a href="#">Extra Pages</a>
							<ul>
								...
								<li><a href="<?= site_url() ?>travelo/extra-pages-before-you-fly.html">Before You
										Fly</a></li>
								<li><a href="<?= site_url() ?>travelo/extra-pages-inflight-experience.html">Inflight
										Experience</a></li>
								<li><a href="<?= site_url() ?>travelo/extra-pages-things-todo1.html">Things To Do 1</a>
								</li>
								<li><a href="<?= site_url() ?>travelo/extra-pages-things-todo2.html">Things To Do 2</a>
								</li>
								<li><a href="<?= site_url() ?>travelo/extra-pages-travel-essentials.html">Travel
										Essentials</a></li>
								<li><a href="<?= site_url() ?>travelo/extra-pages-travel-stories.html">Travel
										Stories</a></li>
								<li><a href="<?= site_url() ?>travelo/extra-pages-travel-guide.html">Travel Guide</a>
								</li>
								<li><a href="<?= site_url() ?>travelo/extra-pages-travel-ideas.html">Travel Ideas</a>
								</li>
								<li><a href="<?= site_url() ?>travelo/extra-pages-travel-insurance.html">Travel
										Insurance</a></li>
								<li><a href="<?= site_url() ?>travelo/extra-pages-group-booking.html">Group Bookings</a>
								</li>
							</ul>
						</li>
						<li class="menu-item-has-children"><a href="#">Special Pages</a>
				...
				<li class="menu-item-has-children"><a href="#">Bonus</a>
					<ul>
						...
						<li class="menu-item-has-children"><a href="#">7 Inner Start Styles</a>
							<ul>
								<li><a href="#">Default Style</a></li>
								<li><a href="<?= site_url() ?>travelo/inner-starts-style1.html">Inner Start Style 1</a>
								</li>
								<li><a href="<?= site_url() ?>travelo/inner-starts-style2.html">Inner Start Style 2</a>
								</li>
								<li><a href="<?= site_url() ?>travelo/inner-starts-style3.html">Inner Start Style 3</a>
								</li>
								<li><a href="<?= site_url() ?>travelo/inner-starts-style4.html">Inner Start Style 4</a>
								</li>
								<li><a href="<?= site_url() ?>travelo/inner-starts-style5.html">Inner Start Style 5</a>
								</li>
								<li><a href="<?= site_url() ?>travelo/inner-starts-style6.html">Inner Start Style 6</a>
								</li>
							</ul>
						</li>
						<li class="menu-item-has-children"><a href="#">3 Search Styles</a>
	...
	<div id="travelo-signup" class="travelo-signup-box travelo-box">
		<div class="login-social"><a href="#" class="button login-facebook"><i class="soap-icon-facebook"></i>Login with
				Facebook</a> <a href="#" class="button login-googleplus"><i class="soap-icon-googleplus"></i>Login with
				Google+</a></div>
		<div class="seperator">
			<label>OR</label>
		</div>
		<div class="simple-signup">
			<div class="text-center signup-email-section"><a href="#" class="signup-email"><i
